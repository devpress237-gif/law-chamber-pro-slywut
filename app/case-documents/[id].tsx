...
export default function CaseDocumentsScreen() {
  ...
  const filteredDocuments = caseItem.documents.filter(doc => 
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyText}>
        {selectedType === 'all' 
          ? 'This case doesn\'t have any documents uploaded yet.'
          : `No ${selectedType} documents found for this case.`}
      </Text>
      <Pressable 
        style={styles.addButton}
        onPress={() => router.push(`/upload-document?caseId=${caseItem.id}`)}
      >
  ...
  return (
    <View style={commonStyles.container}>
      <Header title="Case Documents" showBack />
